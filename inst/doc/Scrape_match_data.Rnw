...
scrape.demosphere(url, file=file, venue=tag, append=TRUE, get.surface=TRUE, home.adv="home", away.adv="away")
...
Now we have a series of .csv files for these PSPL and OPL leagues.  I put my match data in separate .csv files as I find it easier to find match data when I need to error check later, but you can just have one file name and append everything to that.
...
\end{lstlisting}
Look at \verb@my.tables@ and find which list element (the number) has the matches.  That should be \verb@tb.num@.
...
tag="D6 Umbro"
file=tag
scrape.gotsport(url, file=file, venue=tag, tb.num=8, home.adv="home", away.adv="away", surface="Unk")
\end{lstlisting}
...
tag="NPSL D1"
file=tag
scrape.custom1(url,weeks=weeks, file=file, venue=tag, first.td.tag=4, home.adv="home", away.adv="away", surface="Unk")
...
District III uses the same webpage format.  This league does not show the actual match scores.  It caps the GD at 5.  This will mess up the relative ranking of District III teams, so we need to fix it if possible.  Here I went to the referee website and looked up the actual scores and fixed those manually.  This occurred only in the Gold level.

\begin{lstlisting}
# Update D3 Gold
tag="D3 Gold"
file=tag
url <- "http://www.district-3.org/season_2012/scorekeeping/score_report.php?report_id=B12G" 
scrape.custom1(url, weeks=weeks, file=file, venue=tag, home.adv="home", away.adv="away", surface="Unk")
# Manually correct the underreported scores on D3 website; go here http://www.pcsra.org/inquiry.php
filename=paste(file,".csv",sep="")
scores=read.csv(file=filename, colClasses=c("character"),strip.white=TRUE)
scores$home.score[scores$date=="9/15/2012" & scores$home.team=="Colibri-Rene"]="9"
scores$home.score[scores$date=="9/22/2012" & scores$home.team=="Colibri-Rene"]="12"
scores$home.score[scores$date=="10/6/2012" & scores$home.team=="Colibri-Rene"]="10"
scores$home.score[scores$date=="10/13/2012" & scores$home.team=="Colibri-Rene"]="7"
scores$home.score[scores$date=="10/20/2012" & scores$home.team=="Colibri-Rene"]="12"
scores$home.score[scores$date=="9/22/2012" & scores$away.team=="Nortac Cosmos"]="6"
scores$home.score[scores$date=="10/6/2012" & scores$home.team=="SHSC Strikers"]="7"
write.table(scores, file=filename,row.names=FALSE,col.names=TRUE,append=FALSE,sep=",",qmethod="double")

# Update D3 Silver 1
url = "http://www.district-3.org/season_2012/scorekeeping/score_report.php?report_id=B12S1" 
tag="D3 S1"
file=tag
scrape.custom1(url, weeks=weeks, file=file, venue=tag, home.adv="home", away.adv="away", surface="Unk")
\end{lstlisting}
...
\begin{lstlisting}
file="tournaments"
#this one has tb in 11
url="http://events.gotsport.com/events/schedule.aspx?EventID=24694&GroupID=234874&Gender=Boys&Age=12"
tb=scrape.gotsport(url, file=file, venue="Oswego Nike Cup Gold", tb.num=11, append=TRUE, home.adv="home", away.adv="away", surface="Unk")
url="http://events.gotsport.com/events/schedule.aspx?EventID=24694&GroupID=234875&Gender=Boys&Age=12"
scrape.gotsport(url, file=tourn.file, venue="Oswego Nike Cup Silver", tb.num=11, append=TRUE, home.adv="home", away.adv="away", surface="Unk")
\end{lstlisting}
...
scrape.gotsport(url,file=file, venue=tag, append=TRUE, tb.num=12, date.format="%m/%d/%Y", home.adv="neutral", away.adv="neutral", surface="Grass")
\end{lstlisting}
...
The NW Champions League, Chinook Cup, Sagebrush Cup, River Jam and Rainier Challenge all use Demosphere.
\begin{lstlisting}
# NWCL
url="http://www.northwestchampions.com/schedules/2012/48003952.html"
tag="NWCL"
file="tournaments"
scrape.demosphere(url, file=file, venue=tag, get.surface=TRUE, append=TRUE, home.adv="neutral", away.adv="neutral")

#Chinook Cup Gold
file="tournaments"
url="http://southsidesoccer.org/schedules/2012/46586837.html"
scrape.demosphere(url, file=file, venue="Chinook Cup Gold", get.surface=TRUE, append=TRUE, home.adv="home", away.adv="away")
url="http://southsidesoccer.org/schedules/2012/46586838.html"
scrape.demosphere(url, file=file, venue="Chinook Cup Silver", get.surface=TRUE, append=TRUE, home.adv="home", away.adv="away")

#Sagebrush Classic
url="http://events.gotsport.com/events/schedule.aspx?EventID=23840&GroupID=228813&Gender=Boys&Age=12"
tb=scrape.gotsport(url, file=file, venue="Sagebrush Classic", tb.num=11, append=TRUE, home.adv="home", away.adv="away", surface="Unk")

#River Jam
url="http://www.washingtonpremierfc.com/schedules/2012/47393723.html"
scrape.demosphere(url, file=file, venue="River Jam", get.surface=TRUE, append=TRUE, home.adv="home", away.adv="away")

#Rainer Challenge
url="http://www.washingtonpremierfc.com/schedules/2012/45274431.html"
scrape.demosphere(url, file=file, venue="Rainer Challenge Samba", get.surface=TRUE, append=TRUE, home.adv="home", away.adv="away")
url="http://www.washingtonpremierfc.com/schedules/2012/45274432.html"
scrape.demosphere(url, file=file, venue="Rainer Challenge Copa", get.surface=TRUE, append=TRUE, home.adv="home", away.adv="away")
\end{lstlisting}
